...
#curl -u jigz:'D@t@m33rR0ck5!' -X GET 'https://idas.datameer.com/rest/data/workbook/836/Accounts/download' > Accounts.csv
cat Accounts.csv | sed 's/\"\,\"/\|/g' | sed 's/\"//g' > AccountsInfo.csv
...
do
	...
	cat Template.wbk | sed "s/REPLACE_ME/${REPLACEME_str1}/g"| sed "s/Sources\/Customer_Report_Template/${CustomerName}_Report/g" | sed "s/Customer_Report_Template/${CustomerName}_Report/g"> Template1.wbk
