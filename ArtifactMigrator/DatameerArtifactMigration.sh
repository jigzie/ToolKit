...
#Comment 6: Updated the logic to do check IF statement to be equals ==/-eq and notequals !=/-ne
...
if [[ $2 -ne "both" || $2 -ne "download" ]];
then
	echo "Please send the correct command"
	echo "Commands should be in lowercase for download/upload/both"
	exit 65
fi
